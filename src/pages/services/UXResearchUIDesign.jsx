        ...
        <div style={{ textAlign: 'center', zIndex: 10, position: 'relative' }}>
          <h1 className="hero-headline">
            <span className="hero-line-mask">
              <span className="hero-line-inner" style={{ transform: 'none', opacity: 1, clipPath: 'none' }}>UX Research & UI Design</span>
            </span>
          </h1>
          <p className="hero-description" style={{ margin: '0 auto', opacity: 1, transform: 'none' }}>
            Experiences built around real user needs.
          </p>
        </div>
      </section>
    </div>
...
export default UXResearchUIDesign;
